...
export function PrivacyScrollspy() {
  ...
  const navItems = [
    { id: 'article-01', num: '01', label: 'Data Collection' },
    { id: 'article-02', num: '02', label: 'Information Usage' },
    { id: 'article-03', num: '03', label: 'Third-Party Sharing' },
    { id: 'article-04', num: '04', label: 'Cookies & Tracking' },
    { id: 'article-05', num: '05', label: 'Data Security' },
    { id: 'article-06', num: '06', label: 'Your Rights' },
  ];
