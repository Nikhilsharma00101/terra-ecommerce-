        ...
        <div className="max-w-md w-full bg-[#FBF9F5] border border-[#DDD8CF] p-8 sm:p-10 shadow-xs">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full bg-[#181817] text-[#F6F3ED] py-3.5 text-xs uppercase font-bold tracking-wider transition-all flex items-center justify-center gap-2 cursor-pointer relative ${
