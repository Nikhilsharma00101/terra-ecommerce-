      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className={`flex flex-col lg:flex-row lg:items-end justify-between mb-8 sm:mb-12 gap-6 pb-6 border-b ${
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 w-full sm:w-auto">
            ...
            <div
              className={`p-3 max-w-[200px] text-[10px] sm:text-[11px] leading-tight font-light flex items-center justify-center text-center rounded-xl shadow-2xs ${
                isLight ? 'bg-[#F4F1EB] text-[#55524D] border border-[#E5E0D8]' : 'bg-[#1A1A1A] text-gray-400 border border-[#333333]'
              }`}
            >
              Reviews are exclusively invited from verified purchasers.
            </div>
          </div>
        </div>
